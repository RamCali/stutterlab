...
export async function POST(req: NextRequest) {
  try {
    ...
    const treatmentPath = {
      ...
      therapyHistory: therapyHistory || null,
      tensionLocations: tensionLocations || [],
      blockEmotions: blockEmotions || [],
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      userType: tp.userType || null,
      ageRange: tp.ageRange || null,
      onsetTiming: tp.onsetTiming || null,
      therapyHistory: tp.therapyHistory || null,
      tensionLocations: tp.tensionLocations || [],
      blockEmotions: tp.blockEmotions || [],
      primaryGoalType: tp.primaryGoalType || null,
      dailyTimeCommitment: tp.dailyTimeCommitment || null,
