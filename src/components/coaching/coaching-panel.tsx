                ...
                {tips.map((tip, i) => (
                  <div key={i} className="space-y-1">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-foreground">{tip.doThis}</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <XCircle className="h-3.5 w-3.5 text-red-400 mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-muted-foreground">{tip.notThis}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {rubric && (
              <div className="pt-2 border-t border-primary/10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-semibold text-primary">Am I doing it right?</span>
                </div>
