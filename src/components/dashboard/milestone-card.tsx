      ...
      <Card className="bg-gradient-to-r from-primary/5 to-transparent border-primary/20">
        <CardContent className="pt-5 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-semibold">Program Complete!</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <p className="text-base font-semibold">Next Milestone</p>
              <span className="text-sm bg-amber-500/10 text-amber-600 dark:text-amber-400 px-1.5 py-0.5 rounded font-medium">
